// ------------------------------------------------------------------------------------------------------
// <copyright file="NearWalletStats.cs" company="Nomis">
...
namespace Nomis.Nearblocks.Interfaces.Models
{
    ...
    /// Near wallet stats.
    /// </summary>
    public class NearWalletStats
        : IWalletStats<NearTransactionIntervalData>
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "Near")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The movement of funds on the wallet", GroupName = "Near")]
        ...
        public IEnumerable<NearTransactionIntervalData>? TurnoverIntervals { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last month", GroupName = "Near")]
        public decimal BalanceChangeInLastMonth { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last year", GroupName = "Near")]
        ...
        /// <inheritdoc/>
        [Display(Description = "NFT trading activity", GroupName = "Near")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Display(Description = "NFT worth on wallet", GroupName = "Near")]
