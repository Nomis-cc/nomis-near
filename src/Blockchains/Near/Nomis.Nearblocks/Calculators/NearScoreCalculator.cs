// ------------------------------------------------------------------------------------------------------
// <copyright file="NearScoreCalculator.cs" company="Nomis">
...
{
    /// <summary>
    /// Near wallet score calculator.
    /// </summary>
    internal static class NearScoreCalculator
    {
        ...
        public static double GetScore(this IWalletStats<NearTransactionIntervalData> stats)
        {
            if (stats.NoData)
            {
                return 0;
